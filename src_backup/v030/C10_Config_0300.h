// =======================================================
// File: src/v010/C10_Config_0300.h
// =======================================================
#pragma once
/*
 * ------------------------------------------------------
 * 소스명 : C10_Config_0300.h
 * 모듈약어 : C10
...
class CL_C10_Config {
  private:
    // (요구) config_0272.json
    static constexpr const char* 	s_path_cfg 			= "/json/config_0300.json";
    static constexpr const char* 	s_path_tmp 			= "/json/config_0300.json.tmp";
    static constexpr const char* 	s_path_bak 			= "/json/config_0300.json.bak";

    // SafeBoot state
    static constexpr const char*   s_path_boot           = "/json/boot_state_0300.json";
    static constexpr const char*   s_path_boot_tmp       = "/json/boot_state_0300.json.tmp";
