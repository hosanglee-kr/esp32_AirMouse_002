 ...
 *  - M-4: SAFE/OTA gate 진입·이탈 전용 에러코드 (E10_Def_0400.h)
 *
 * [분할]
 *  - E10_AirMouse_Core_0400.cpp   : 초기화/런타임 적용
 *  - E10_AirMouse_Hid_0400.cpp    : HID 출력/테스트/강제 릴리즈
 *  - E10_AirMouse_Motion_0400.cpp : precision/FSM
 *  - E10_AirMouse_Diag_0400.cpp   : 진단/캘리브/status
 *  - E10_AirMouse_Task_0400.cpp   : sensorTask / commTask
 */
