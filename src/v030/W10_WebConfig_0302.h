// =======================================================
// File: src/v010/W10_WebConfig_0302.h
// =======================================================
#pragma once
    ...
    void apiControl(AsyncWebServerRequest* req, uint8_t* data, size_t len, size_t index, size_t total) {
        ...
        if (!e10 || !v_cmd || v_cmd[0] == '\0') {
            ...
            if (strcmp(v_cmd, "ppt_mode") == 0) {
                ...
                // 비동기 요청: sensorTask에서 수행
                ok = e10->requestGyroCalibration();
    
            } else if (strcmp(v_cmd, "i2c_recover") == 0) {
                // 비동기 요청: sensorTask에서 수행
                ok = e10->requestI2CRecover();
    
            } else if (strcmp(v_cmd, "clear_diag") == 0) {
                ok = e10->clearDiagnostics();
