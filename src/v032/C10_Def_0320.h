...
// -------------------------------------------------------
static constexpr uint16_t G_C10_CFG_VER = 320; // 스키마 버전(권장: 파일명과 분리)

namespace C10_DEF {
    // ---------- Paths ----------
    static constexpr const char* CFG_PATH = "/json/config_0320.json";
    static constexpr const char* CFG_TMP  = "/json/config_0320.json.tmp";
    static constexpr const char* CFG_BAK  = "/json/config_0320.json.bak";

    static constexpr const char* BOOT_PATH     = "/json/boot_state_0320.json";
    static constexpr const char* BOOT_TMP_PATH = "/json/boot_state_0320.json.tmp";
